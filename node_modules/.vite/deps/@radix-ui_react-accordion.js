...
// node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-compose-refs/dist/index.mjs
...
// node_modules/@radix-ui/react-primitive/node_modules/@radix-ui/react-slot/dist/index.mjs
var $5e63c961fc1ce211$export$8c6ed5c666ac13602 = (0, import_react10.forwardRef)((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  ...
  if (slottable) {
    ...
    return (0, import_react10.createElement)($5e63c961fc1ce211$var$SlotClone2, _extends({}, slotProps, {
      ref: forwardedRef
...
var $5e63c961fc1ce211$var$SlotClone2 = (0, import_react10.forwardRef)((props, forwardedRef) => {
  const { children, ...slotProps } = props;
...
function $5e63c961fc1ce211$var$isSlottable2(child) {
  return (0, import_react10.isValidElement)(child) && child.type === $5e63c961fc1ce211$export$d9f1ccf0bdb05d452;
}
...
var $8927f6f2acc4f386$export$250ffa63cdc0d034 = $8927f6f2acc4f386$var$NODES.reduce((primitive, node) => {
  const Node = (0, import_react11.forwardRef)((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? $5e63c961fc1ce211$export$8c6ed5c666ac13602 : node;
    (0, import_react11.useEffect)(() => {
      window[Symbol.for("radix-ui")] = true;
    }, []);
    return (0, import_react11.createElement)(Comp, _extends({}, primitiveProps, {
      ref: forwardedRef
    }));
  });
...
function $6ed0406888f73fc4$export$c7b2cbe3552a0d053(...refs) {
  return (0, import_react16.useCallback)($6ed0406888f73fc4$export$43e446d32b3d21af4(...refs), refs);
}
...
var [$409067139f391064$var$createCollapsibleContext, $409067139f391064$export$952b32dcbe73087a] = $c512c27ab02ef895$export$50c7b4e9d9f19c13($409067139f391064$var$COLLAPSIBLE_NAME);
...
var $409067139f391064$export$6eb0f7ddcda6131f = (0, import_react18.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react18.createElement)($409067139f391064$var$CollapsibleProvider, {
...
var $409067139f391064$export$c135dce7b15bbbdc = (0, import_react18.forwardRef)((props, forwardedRef) => {
  const { __scopeCollapsible, ...triggerProps } = props;
  const context = $409067139f391064$var$useCollapsibleContext($409067139f391064$var$TRIGGER_NAME, __scopeCollapsible);
  return (0, import_react18.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.button, _extends({
    type: "button",
...
var $409067139f391064$export$aadde00976f34151 = (0, import_react18.forwardRef)((props, forwardedRef) => {
  ...
  return (0, import_react18.createElement)(
    ...
    ({ present }) => (0, import_react18.createElement)($409067139f391064$var$CollapsibleContentImpl, _extends({}, contentProps, {
      ref: forwardedRef,
      present
    }))
  );
...
var $409067139f391064$var$CollapsibleContentImpl = (0, import_react18.forwardRef)((props, forwardedRef) => {
  const { __scopeCollapsible, present, children, ...contentProps } = props;
  const context = $409067139f391064$var$useCollapsibleContext($409067139f391064$var$CONTENT_NAME, __scopeCollapsible);
  const [isPresent, setIsPresent] = (0, import_react18.useState)(present);
  const ref = (0, import_react18.useRef)(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d053(forwardedRef, ref);
  const heightRef = (0, import_react18.useRef)(0);
  const height = heightRef.current;
  const widthRef = (0, import_react18.useRef)(0);
  const width = widthRef.current;
  const isOpen = context.open || isPresent;
  const isMountAnimationPreventedRef = (0, import_react18.useRef)(isOpen);
  const originalStylesRef = (0, import_react18.useRef)();
  ...
  return (0, import_react18.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({
    "data-state": $409067139f391064$var$getState(context.open),
    "data-disabled": context.disabled ? "" : void 0,
...
var $9f79659886946c16$export$e5c5a5f917a5871c2 = Boolean(globalThis === null || globalThis === void 0 ? void 0 : globalThis.document) ? import_react19.useLayoutEffect : () => {
};
...
var $f631663db3294ace$var$DirectionContext = (0, import_react20.createContext)(void 0);
function $f631663db3294ace$export$b39126d51d94e6f3(localDir) {
  const globalDir = (0, import_react20.useContext)($f631663db3294ace$var$DirectionContext);
...
var $1bf158f521e1b1b4$export$a766cd26d0d69044 = import_react21.default.forwardRef((props, forwardedRef) => {
  const { type, ...accordionProps } = props;
  const singleProps = accordionProps;
  const multipleProps = accordionProps;
  return import_react21.default.createElement($1bf158f521e1b1b4$var$Collection.Provider, {
    scope: props.__scopeAccordion
  }, type === "multiple" ? import_react21.default.createElement($1bf158f521e1b1b4$var$AccordionImplMultiple, _extends({}, multipleProps, {
    ref: forwardedRef
  })) : import_react21.default.createElement($1bf158f521e1b1b4$var$AccordionImplSingle, _extends({}, singleProps, {
    ref: forwardedRef
  })));
});
...
var $1bf158f521e1b1b4$var$AccordionImplSingle = import_react21.default.forwardRef((props, forwardedRef) => {
  ...
  return import_react21.default.createElement($1bf158f521e1b1b4$var$AccordionValueProvider, {
    scope: props.__scopeAccordion,
    value: value ? [
      value
    ] : [],
    onItemOpen: setValue,
    onItemClose: import_react21.default.useCallback(
  ...
  }, import_react21.default.createElement($1bf158f521e1b1b4$var$AccordionCollapsibleProvider, {
    scope: props.__scopeAccordion,
    collapsible
  }, import_react21.default.createElement($1bf158f521e1b1b4$var$AccordionImpl, _extends({}, accordionSingleProps, {
    ref: forwardedRef
  }))));
});
var $1bf158f521e1b1b4$var$AccordionImplMultiple = import_react21.default.forwardRef((props, forwardedRef) => {
  const { value: valueProp, defaultValue, onValueChange = () => {
  ...
  const handleItemOpen = import_react21.default.useCallback(
    (itemValue) => setValue(
      (prevValue = []) => [
        ...prevValue,
        itemValue
  ...
  const handleItemClose = import_react21.default.useCallback(
    (itemValue) => setValue(
  ...
  return import_react21.default.createElement($1bf158f521e1b1b4$var$AccordionValueProvider, {
    ...
    scope: props.__scopeAccordion,
    collapsible: true
  }, import_react21.default.createElement($1bf158f521e1b1b4$var$AccordionImpl, _extends({}, accordionMultipleProps, {
    ref: forwardedRef
  }))));
});
...
var $1bf158f521e1b1b4$var$AccordionImpl = import_react21.default.forwardRef((props, forwardedRef) => {
  const { __scopeAccordion, disabled, dir, orientation = "vertical", ...accordionProps } = props;
  const accordionRef = import_react21.default.useRef(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d052(accordionRef, forwardedRef);
  ...
  return import_react21.default.createElement($1bf158f521e1b1b4$var$AccordionImplProvider, {
    scope: __scopeAccordion,
    disabled,
    direction: dir,
    orientation
  }, import_react21.default.createElement($1bf158f521e1b1b4$var$Collection.Slot, {
    scope: __scopeAccordion
  }, import_react21.default.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends({}, accordionProps, {
...
var $1bf158f521e1b1b4$export$d99097c13d4dac9f = import_react21.default.forwardRef((props, forwardedRef) => {
  ...
  const triggerId = $1746a345f3d73bb7$export$f680877a34711e372();
  const open1 = value && valueContext.value.includes(value) || false;
  const disabled = accordionContext.disabled || props.disabled;
  return import_react21.default.createElement($1bf158f521e1b1b4$var$AccordionItemProvider, {
    scope: __scopeAccordion,
    open: open1,
    disabled,
    triggerId
  }, import_react21.default.createElement($409067139f391064$export$be92b6f5f03c0fe9, _extends({
...
var $1bf158f521e1b1b4$export$5e3e5deaaf81ee41 = import_react21.default.forwardRef((props, forwardedRef) => {
  ...
  return import_react21.default.createElement($8927f6f2acc4f386$export$250ffa63cdc0d034.h3, _extends({
    "data-orientation": accordionContext.orientation,
...
var $1bf158f521e1b1b4$export$94e939b1f85bdd73 = import_react21.default.forwardRef((props, forwardedRef) => {
  ...
  const collapsibleScope = $1bf158f521e1b1b4$var$useCollapsibleScope(__scopeAccordion);
  return import_react21.default.createElement($1bf158f521e1b1b4$var$Collection.ItemSlot, {
    scope: __scopeAccordion
  }, import_react21.default.createElement($409067139f391064$export$41fb9f06171c75f4, _extends({
...
var $1bf158f521e1b1b4$export$985b9a77379b54a0 = import_react21.default.forwardRef((props, forwardedRef) => {
  ...
  const collapsibleScope = $1bf158f521e1b1b4$var$useCollapsibleScope(__scopeAccordion);
  return import_react21.default.createElement($409067139f391064$export$7c6e2c02157bb7d2, _extends({
    role: "region",
